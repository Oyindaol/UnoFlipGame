...
public class UNOFrame extends JFrame implements UNOView {
    ...
    public void init(){
        ...
        int numberOfHumanPlayers = Integer.parseInt(JOptionPane.showInputDialog("Enter number of Human Players"));

        int numberOfAIPlayers = Integer.parseInt(JOptionPane.showInputDialog("Enter number of AI Players"));


        int totalPlayers = numberOfHumanPlayers + numberOfAIPlayers;
        while (totalPlayers != numPlayers) {

            JOptionPane.showMessageDialog(null, "The players don't add up to Total players");

            numberOfHumanPlayers = Integer.parseInt(JOptionPane.showInputDialog("Enter number of human Players"));
            numberOfAIPlayers = Integer.parseInt(JOptionPane.showInputDialog("Enter number of AI Players"));
        ...
        for (int i = 0; i < numberOfAIPlayers; i++) {
            ...
            model.addPlayer(new AIPlayer(playerName));
        }
